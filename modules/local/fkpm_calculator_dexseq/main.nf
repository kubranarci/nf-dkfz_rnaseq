process FKPM_CALCULATOR_DEXSEQ {
    tag "${meta.id}"
    ...
    SCRIPT_PATH=\$(command -v featureCountsDexseq_2_FpkmTpm.pl || true)
    
    if [ -z "\$SCRIPT_PATH" ]; then
        echo "ERROR: featureCountsDexseq_2_FpkmTpm.pl not found in PATH."
    ...
    featureCountsDexseq_2_FpkmTpm.pl \\
        $featurecounts \\
        $gtf \\
        $gtf_exclude \\
        > ${prefix}.tsv
